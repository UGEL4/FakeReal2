...
namespace FakeReal
{
    ...
    public:
        ...
        void RegisterKeyCallback(const OnKeyCallback& func)
        {
            mOnKeyCallbacks.emplace_back(func);
        }
        void RegisterCharCallback(const OnCharCallback& func)
        {
            mOnCharCallbacks.emplace_back(func);
        }
        void RegisterCharModsCallback(const OnCharModsCallback& func)
        {
            mOnCharModsCallbacks.emplace_back(func);
        }
        void RegisterMouseButtonCallback(const OnMouseButtonCallback& func)
        {
            mOnMouseButtonCallbacks.emplace_back(func);
        }
        void RegisterCursorPosCallback(const OnCursorPosCallback& func)
        {
            mOnCursorPosCallbacks.emplace_back(func);
        }
        void RegisterCursorEnterCallback(const OnCursorEnterCallback& func)
        {
            mOnCursorEnterCallbacks.emplace_back(func);
        }
        void RegisterScrollCallback(const OnScrollCallback& func)
        {
            mOnScrollCallbacks.emplace_back(func);
        }
        void RegisterDropCallback(const OnDropCallback& func)
        {
            mOnDropCallbacks.emplace_back(func);
        }
        void RegisterWindowSizeCallback(const OnWindowSizeCallback& func)
        {
            mOnWindowSizeCallbacks.emplace_back(func);
        }
        void RegisterWindowCloseCallback(const OnWindowCloseCallback& func)
        {
            mOnWindowCloseCallbacks.emplace_back(func);
        }
